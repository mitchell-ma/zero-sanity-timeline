...
- Operator-specific baked-in keys need manual DSL conversion
- Statuses file needs creation (talents + potential statuses)
- Operator JSON talent IDs need linking
