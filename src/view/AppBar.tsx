...
export default function AppBar({ onClear, onExport, onImport, onDevlog, onKeys, scrollSynced, onToggleScrollSync }: AppBarProps) {
  return (
    <div className="app-bar">
      ...
      <button
        className={`btn-scroll-sync${scrollSynced ? ' btn-scroll-sync--active' : ''}`}
