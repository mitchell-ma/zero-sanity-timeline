import { CombatResourceType, CombatSkillType, StatusType, TriggerConditionType } from "./enums";
...
export type RequirementType = StatusType | CombatResourceType | CombatSkillType | TriggerConditionType;
