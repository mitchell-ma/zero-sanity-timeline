...
export const WEAPON_SKILL_EFFECTS: WeaponEffectsEntry[] = [
  ...
  // Forgeborn Scathe — Twilight: Blazing Wail (Cast Ultimate)
  {
    ...
    effects: [{
      ...
      triggers: [_IO(THIS, PERFORM, ObjectType.ULTIMATE)],
      target: 'wielder',
      durationSeconds: 20,
      maxStacks: 1,
      cooldownSeconds: 0,
  ...
  // Eminent Repute — Brutality: Disciplinarian (Consume Vulnerability)
  {
    ...
    effects: [{
      ...
      triggers: [_IO(THIS, CONSUME, ObjectType.STATUS, { objectId: "VULNERABILITY" })],
      target: 'wielder',
      durationSeconds: 20,
      maxStacks: 1,
      cooldownSeconds: 0,
  ...
  // White Night Nova — Infliction: White Night Nova (Apply Arts Reaction)
  {
    ...
    effects: [{
      ...
      triggers: [_IO(THIS, APPLY, ObjectType.REACTION)],
      target: 'wielder',
      durationSeconds: 15,
      maxStacks: 1,
      cooldownSeconds: 0,
  ...
  // Aspirant — Twilight: Imposing Peak (Apply Lifted)
  {
    ...
    effects: [{
      ...
      triggers: [_IO(THIS, APPLY, ObjectType.STATUS, { objectId: "LIFTED" })],
      target: 'wielder',
      durationSeconds: 30,
      maxStacks: 3,
      cooldownSeconds: 0,
  ...
  // Twelve Questions — Infliction: Sincere Interrogation (Consume Arts Reaction)
  {
    ...
    effects: [{
      ...
      triggers: [_IO(THIS, CONSUME, ObjectType.REACTION)],
      target: 'wielder',
      durationSeconds: 20,
      maxStacks: 2,
      cooldownSeconds: 0,
  ...
  // Sundered Prince — Crusher: Princely Deterrence (Final Strike)
  {
    ...
    effects: [{
      ...
      triggers: [_IO(THIS, PERFORM, ObjectType.FINAL_STRIKE)],
      target: 'wielder',
      durationSeconds: 8,
      maxStacks: 1,
      cooldownSeconds: 0,
  ...
  // Khravengger — Detonate: Bonechilling (Apply Cryo Infliction / Combo on Cryo)
  {
    ...
    effects: [{
      ...
      triggers: [_IO(THIS, APPLY, ObjectType.INFLICTION, { element: "CRYO" })],
      target: 'wielder',
      durationSeconds: 15,
      maxStacks: 1,
      cooldownSeconds: 0,
  ...
  // OBJ Heavy Burden — Efficacy: Tenacious Will (Apply Knock Down/Weakened)
  {
    ...
    effects: [{
      ...
      triggers: [_IO(THIS, APPLY, ObjectType.STATUS, { objectId: "KNOCKED_DOWN" })],
      target: 'wielder',
      durationSeconds: 15,
      maxStacks: 1,
      cooldownSeconds: 0,
  ...
  // Seeker of Dark Lung — Detonate: Seeker of the Esoteric (Apply Arts Burst)
  {
    ...
    effects: [{
      ...
      triggers: [_IO(THIS, APPLY, ObjectType.ARTS_REACTION)],
      target: 'wielder',
      durationSeconds: 30,
      maxStacks: 3,
      cooldownSeconds: 0,
  ...
  // Former Finery — Mincing Therapy (Protected Operator Takes DMG)
  {
    ...
    effects: [{
      ...
      triggers: [_I(ENEMY, HIT, ObjectType.OPERATOR)],
      target: 'wielder',
      durationSeconds: 15,
      maxStacks: 1,
      cooldownSeconds: 15,
  ...
  // JET — Suppression: Astrophysics (Cast Battle Skill / Cast Combo Skill)
  {
    ...
    effects: [{
      ...
      triggers: [_IO(THIS, PERFORM, ObjectType.BATTLE_SKILL), _IO(THIS, PERFORM, ObjectType.COMBO_SKILL)],
      target: 'wielder',
      durationSeconds: 15,
      maxStacks: 1,
      cooldownSeconds: 0,
  ...
  // Rational Farewell — Pursuit: Aid from the Past (Combo applies Arts Burst/Combustion)
  {
    ...
    effects: [{
      ...
      triggers: [_IO(THIS, APPLY, ObjectType.ARTS_REACTION), _I(ENEMY, IS, ObjectType.COMBUSTED)],
      target: 'wielder',
      durationSeconds: 15,
      maxStacks: 1,
      cooldownSeconds: 0,
    ...
    effects: [
      {
        ...
        triggers: [_IO(THIS, CONSUME, ObjectType.REACTION, { objectId: "CORROSION" })],
        target: 'wielder',
        durationSeconds: 25,
        maxStacks: 1,
        cooldownSeconds: 0,
  ...
  // Oblivion — Twilight: Humiliation (Cast Ultimate / Cast Combo)
  {
    ...
    effects: [{
      ...
      triggers: [_IO(THIS, PERFORM, ObjectType.ULTIMATE), _IO(THIS, PERFORM, ObjectType.COMBO_SKILL)],
      target: 'wielder',
      durationSeconds: 15,
      maxStacks: 1,
      cooldownSeconds: 0,
  ...
  // OBJ Arts Identifier — Pursuit: Transcendent Arts (Combo applies Arts Burst/Physical Status)
  {
    ...
    effects: [{
      ...
      triggers: [_IO(THIS, APPLY, ObjectType.ARTS_REACTION), _IO(THIS, APPLY, ObjectType.STATUS)],
      target: 'team',
      durationSeconds: 15,
      maxStacks: 1,
      cooldownSeconds: 0,
