...
const GEAR_LIST_URL = 'https://api.warfarin.wiki/v1/en/gear?version=1.2';
...
const SUIT_ID_TO_GEAR_EFFECT_TYPE: Record<string, string> = {
  suit_fire_natr01: 'HOT_WORK_STAT',
  suit_pulse_cryst01: 'PULSER_LABS_STAT',
  suit_poise01: 'AETHERTECH_STAT',
  suit_phy01: 'SWORDMANCER_STAT',
  suit_criti01: 'MI_SECURITY_STAT',
  suit_atb01: 'FRONTIERS_STAT',
  suit_atk02: 'TYPE_50_YINGLUNG_STAT',
  suit_heal01: 'LYNX_STAT',
  suit_usp02: 'ETERNAL_XIRANITE_STAT',
  suit_attri01: 'BONEKRUSHA_STAT',
  suit_usp01: 'CATASTROPHE_STAT',
  suit_atk01: 'ABURREY_LEGACY_STAT',
  suit_str01: 'ARMORED_MSGR_STAT',
  suit_agi01: 'ROVING_MSGR_STAT',
  suit_wisd01: 'MORDVOLT_INSULATION_STAT',
  suit_will01: 'MORDVOLT_RESISTANT_STAT',
  suit_stragi01: 'AIC_HEAVY_STAT',
  suit_wisdwill01: 'AIC_LIGHT_STAT',
  suit_burst01: 'TIDE_SURGE_STAT',
  suit_combo_cd01: 'QINGBO_STAT',
  suit_expend_spell01: 'XIRANFLOW_STAT',
};

// Reverse for filename generation
const GEAR_EFFECT_TO_SLUG: Record<string, string> = {
  HOT_WORK_STAT: 'hot-work',
  PULSER_LABS_STAT: 'pulser-labs',
  AETHERTECH_STAT: 'aethertech',
  SWORDMANCER_STAT: 'swordmancer',
  MI_SECURITY_STAT: 'mi-security',
  FRONTIERS_STAT: 'frontiers',
  TYPE_50_YINGLUNG_STAT: 'type-50-yinglung',
  LYNX_STAT: 'lynx',
  ETERNAL_XIRANITE_STAT: 'eternal-xiranite',
  BONEKRUSHA_STAT: 'bonekrusha',
  CATASTROPHE_STAT: 'catastrophe',
  ABURREY_LEGACY_STAT: 'aburrey-legacy',
  ARMORED_MSGR_STAT: 'armored-msgr',
  ROVING_MSGR_STAT: 'roving-msgr',
  MORDVOLT_INSULATION_STAT: 'mordvolt-insulation',
  MORDVOLT_RESISTANT_STAT: 'mordvolt-resistant',
  AIC_HEAVY_STAT: 'aic-heavy',
  AIC_LIGHT_STAT: 'aic-light',
  TIDE_SURGE_STAT: 'tide-surge',
  QINGBO_STAT: 'qingbo',
  XIRANFLOW_STAT: 'xiranflow',
  NONE: 'no-set',
};
